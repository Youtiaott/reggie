...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://101.132.79.111:3306/reggie?serverTimezone=GMT");//驱动连接的URL
        dsc.setDriverName("com.mysql.jdbc.Driver");//驱动名称
        dsc.setUsername("root");//数据库连接用户名
        dsc.setPassword("wjq200165");//数据库连接密码
        ...
        pc.setParent("com.example.reggie"); // 生成的代码的父路径
        ...
        strategy.setInclude("address_book","category","dish_flavor","dish","orders","employee","order_detail","setmeal","setmeal_dish","shopping_cart","user"); // 要生成的表在数据库中的名称, 每张表名以英文逗号隔开,例: ("user","system_log")
